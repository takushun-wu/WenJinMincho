...
- Any modifications, extensions and format conversions to the font files **must be published under the *SIL Open Font License***, and the **reserved name of the font (and its translated forms in other languages) must not be used: WenJin Mincho, <span lang="zh-Hans">文津宋体</span>, <span lang="zh-Hant">文津宋體</span>, <span lang="ja">文津明朝</span>, <span lang="ko">문진(文津) 명조</span>** (if only the source font is converted to the format conversion without any other modifications the reserved name may continue to be used).
### You cannot do...
